...
@section('contenido')
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-bold text-primary mb-1">Nuevo Examen</h1>
        ...
        <form method="post" action="{{ route('docente.examenes.guardar', $curso) }}">
            ...
            <div class="mb-5">
                ...
                <input type="text" name="titulo" value="{{ old('titulo') }}"
                    class="w-full px-4 py-2.5 border-2 border-gray-200 rounded-sm" required>
                @error('titulo')
            ...
            <div class="mb-5">
                ...
                <textarea name="descripcion" rows="3" class="w-full px-4 py-2.5 border-2 border-gray-200 rounded-sm">{{ old('descripcion') }}</textarea>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                ...
                <div>
                    ...
                    <input type="number" name="tiempo_limite" value="{{ old('tiempo_limite') }}" min="1"
                        class="w-full px-4 py-3 border-2 border-gray-200 rounded-sm" placeholder="Sin límite">
                </div>
            </div>
