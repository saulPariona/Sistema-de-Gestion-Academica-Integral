...
<body class="w-full min-h-screen flex flex-col bg-main">
        ...
        @if (auth()->user()->esDocente())
                ...
                <div class="max-w-7xl mx-auto px-2 py-2">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-2 md:gap-4">
                            <img src="{{ asset('image/logo_1.png') }}" alt="Logo" class="h-10 w-10 md:h-12 md:w-12 object-contain bg-white rounded-full p-1">
                            <div>
                                <h1 class="text-lg md:text-2xl font-bold text-accent tracking-wide font-serif">Colegio Max Planck</h1>
                                <p class="text-xs text-accent font-serif hidden sm:block">Sistema de Gestión Académica</p>
                            </div>
                        </div>
                        <div class="flex items-center gap-2 md:gap-4">
                            ...
                            @if (auth()->user()->foto_perfil)
                                <img src="{{ asset('storage/' . auth()->user()->foto_perfil) }}" alt="Foto" class="w-9 h-9 md:w-10 md:h-10 rounded-full object-cover border-2 border-accent shadow-md">
                            @else
                                <div class="w-9 h-9 md:w-10 md:h-10 rounded-full bg-accent flex items-center justify-center text-primary font-bold text-lg">
                                    {{ strtoupper(substr(auth()->user()->nombres, 0, 1)) }}
                                </div>
                            @endif
                            <a class="hidden md:inline-block text-sm text-primary bg-accent hover:bg-yellow-200 px-4 py-2 rounded-sm font-semibold transition-all shadow-md font-serif"
                                href="{{ route('logout') }}">Salir</a>
                            <button onclick="toggleMobileNav()" class="md:hidden text-accent p-1" aria-label="Menú">
            ...
            <nav class="bg-primary-dark shadow-md">
                <div class="max-w-7xl mx-auto px-4">
                    ...
                    <!-- Mobile -->
                    <div id="mobile-nav" class="hidden md:!hidden flex-col py-2">
                        <a href="{{ route('docente.dashboard') }}" 
                           class="px-4 py-3 text-accent hover:bg-primary transition-all rounded {{ request()->routeIs('docente.dashboard') ? 'bg-primary' : '' }}">
                            <span class="flex items-center gap-2 text-sm font-serif">
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z"/>
                                </svg>
                        ...
                        <a href="{{ route('password.change') }}" 
                           class="px-4 py-3 text-accent hover:bg-primary transition-all rounded">
                            <span class="flex items-center gap-2 text-sm font-serif">
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clip-rule="evenodd"/>
                                </svg>
                        ...
                        <div class="border-t border-gray-700 mt-2 pt-2">
                            <a href="{{ route('logout') }}" class="px-4 py-3 text-red-300 hover:bg-primary transition-all rounded">
                                <span class="flex items-center gap-2 text-sm font-serif">
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M3 3a1 1 0 00-1 1v12a1 1 0 001 1h12a1 1 0 001-1V4a1 1 0 00-1-1H3zm7.707 4.293a1 1 0 010 1.414L9.414 10l1.293 1.293a1 1 0 01-1.414 1.414l-2-2a1 1 0 010-1.414l2-2a1 1 0 011.414 0zM13 8a1 1 0 100 2h2a1 1 0 100-2h-2z" clip-rule="evenodd"/>
                                    </svg>
                                    Salir
                                </span>
                            </a>
        ...
        @elseif(auth()->user()->esEstudiante())
            ...
            <nav class="bg-primary-dark shadow-md">
                <div class="max-w-7xl mx-auto px-4">
                    ...
                    <div id="mobile-nav" class="hidden md:!hidden flex-col py-2">
                        <a href="{{ route('estudiante.dashboard') }}" 
                           class="px-4 py-3 text-accent hover:bg-primary transition-all rounded {{ request()->routeIs('estudiante.dashboard', 'estudiante.curso', 'estudiante.examenes', 'estudiante.rendir-examen', 'estudiante.resultado-examen') ? 'bg-primary' : '' }}">
                            <span class="flex items-center gap-2 text-sm font-serif">
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z"/>
                                </svg>
                        ...
                        <a href="{{ route('estudiante.calificaciones') }}" 
                           class="px-4 py-3 text-accent hover:bg-primary transition-all rounded {{ request()->routeIs('estudiante.calificaciones') ? 'bg-primary' : '' }}">
                            <span class="flex items-center gap-2 text-sm font-serif">
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M9 2a1 1 0 000 2h2a1 1 0 100-2H9z"/>
                                    <path fill-rule="evenodd" d="M4 5a2 2 0 012-2 3 3 0 003 3h2a3 3 0 003-3 2 2 0 012 2v11a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm3 4a1 1 0 000 2h.01a1 1 0 100-2H7zm3 0a1 1 0 000 2h3a1 1 0 100-2h-3zm-3 4a1 1 0 100 2h.01a1 1 0 100-2H7zm3 0a1 1 0 100 2h3a1 1 0 100-2h-3z" clip-rule="evenodd"/>
                        ...
                        <a href="{{ route('estudiante.perfil') }}" 
                           class="px-4 py-3 text-accent hover:bg-primary transition-all rounded {{ request()->routeIs('estudiante.perfil*') ? 'bg-primary' : '' }}">
                            <span class="flex items-center gap-2 text-sm font-serif">
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd"/>
                                </svg>
        ...
        @elseif(auth()->user()->esAdministrador())
            ...
            <nav class="bg-primary-dark shadow-md">
                <div class="max-w-7xl mx-auto px-4">
                    ...
                    <div id="mobile-nav" class="hidden md:!hidden flex-col py-2">
                        <a href="{{ route('admin.dashboard') }}" 
                           class="px-4 py-3 text-accent hover:bg-primary transition-all rounded {{ request()->routeIs('admin.dashboard') ? 'bg-primary' : '' }}">
                            <span class="flex items-center gap-2 text-sm font-serif">
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z"/>
                                </svg>
                        ...
                        <a href="{{ route('admin.usuarios') }}" 
                           class="px-4 py-3 text-accent hover:bg-primary transition-all rounded {{ request()->routeIs('admin.usuarios*') ? 'bg-primary' : '' }}">
                            <span class="flex items-center gap-2 text-sm font-serif">
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M9 6a3 3 0 11-6 0 3 3 0 016 0zM17 6a3 3 0 11-6 0 3 3 0 016 0zM12.93 17c.046-.327.07-.66.07-1a6.97 6.97 0 00-1.5-4.33A5 5 0 0119 16v1h-6.07zM6 11a5 5 0 015 5v1H1v-1a5 5 0 015-5z"/>
                                </svg>
                        ...
                        <a href="{{ route('admin.periodos') }}" 
                           class="px-4 py-3 text-accent hover:bg-primary transition-all rounded {{ request()->routeIs('admin.periodos*') ? 'bg-primary' : '' }}">
                            <span class="flex items-center gap-2 text-sm font-serif">
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clip-rule="evenodd"/>
                                </svg>
                        ...
                        <a href="{{ route('admin.cursos') }}" 
                           class="px-4 py-3 text-accent hover:bg-primary transition-all rounded {{ request()->routeIs('admin.cursos*') ? 'bg-primary' : '' }}">
                            <span class="flex items-center gap-2 text-sm font-serif">
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M10.394 2.08a1 1 0 00-.788 0l-7 3a1 1 0 000 1.84L5.25 8.051a.999.999 0 01.356-.257l4-1.714a1 1 0 11.788 1.838L7.667 9.088l1.94.831a1 1 0 00.787 0l7-3a1 1 0 000-1.838l-7-3zM3.31 9.397L5 10.12v4.102a8.969 8.969 0 00-1.05-.174 1 1 0 01-.89-.89 11.115 11.115 0 01.25-3.762zM9.3 16.573A9.026 9.026 0 007 14.935v-3.957l1.818.78a3 3 0 002.364 0l5.508-2.361a11.026 11.026 0 01.25 3.762 1 1 0 01-.89.89 8.968 8.968 0 00-5.35 2.524 1 1 0 01-1.4 0zM6 18a1 1 0 001-1v-2.065a8.935 8.935 0 00-2-.712V17a1 1 0 001 1z"/>
                                </svg>
                        ...
                        <a href="{{ route('admin.matriculas') }}" 
                           class="px-4 py-3 text-accent hover:bg-primary transition-all rounded {{ request()->routeIs('admin.matriculas*') ? 'bg-primary' : '' }}">
                            <span class="flex items-center gap-2 text-sm font-serif">
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M9 4.804A7.968 7.968 0 005.5 4c-1.255 0-2.443.29-3.5.804v10A7.969 7.969 0 015.5 14c1.669 0 3.218.51 4.5 1.385A7.962 7.962 0 0114.5 14c1.255 0 2.443.29 3.5.804v-10A7.968 7.968 0 0014.5 4c-1.255 0-2.443.29-3.5.804V12a1 1 0 11-2 0V4.804z"/>
                                </svg>
                        ...
                        <a href="{{ route('admin.calificaciones') }}" 
                           class="px-4 py-3 text-accent hover:bg-primary transition-all rounded {{ request()->routeIs('admin.calificaciones*') ? 'bg-primary' : '' }}">
                            <span class="flex items-center gap-2 text-sm font-serif">
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M9 2a1 1 0 000 2h2a1 1 0 100-2H9z"/>
                                    <path fill-rule="evenodd" d="M4 5a2 2 0 012-2 3 3 0 003 3h2a3 3 0 003-3 2 2 0 012 2v11a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm3 4a1 1 0 000 2h.01a1 1 0 100-2H7zm3 0a1 1 0 000 2h3a1 1 0 100-2h-3zm-3 4a1 1 0 100 2h.01a1 1 0 100-2H7zm3 0a1 1 0 100 2h3a1 1 0 100-2h-3z" clip-rule="evenodd"/>
                        ...
                        <a href="{{ route('admin.auditorias') }}" 
                           class="px-4 py-3 text-accent hover:bg-primary transition-all rounded {{ request()->routeIs('admin.auditorias*') ? 'bg-primary' : '' }}">
                            <span class="flex items-center gap-2 text-sm font-serif">
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M3 5a2 2 0 012-2h10a2 2 0 012 2v8a2 2 0 01-2 2h-2.22l.123.489.804.804A1 1 0 0113 18H7a1 1 0 01-.707-1.707l.804-.804L7.22 15H5a2 2 0 01-2-2V5zm5.771 7H5V5h10v7H8.771z" clip-rule="evenodd"/>
                                </svg>
    ...
    <main class="grow w-full max-w-7xl mx-auto p-3 md:p-6">
    @if (session('status'))
        <div
            class="mb-4 p-3 md:p-4 bg-green-50 border-l-4 border-green-500 text-green-800 rounded-r shadow-md flex items-center gap-3">
            <svg class="w-5 h-5 md:w-6 md:h-6 text-green-500 shrink-0" fill="currentColor" viewBox="0 0 20 20">
    ...
    @if (session('error'))
        <div
            class="mb-4 p-3 md:p-4 bg-red-50 border-l-4 border-red-500 text-red-800 rounded-r shadow-md flex items-center gap-3">
            <svg class="w-5 h-5 md:w-6 md:h-6 text-red-500 shrink-0" fill="currentColor" viewBox="0 0 20 20">
                <path fill-rule="evenodd"
