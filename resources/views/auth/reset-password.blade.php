    ...
    <div class="fixed inset-0 flex flex-col md:flex-row z-40">
        ...
        <div class="w-full md:w-1/2 flex items-center justify-center bg-white overflow-y-auto">
            <div class="w-full max-w-sm px-8 py-10 md:py-0">
                ...
                <div class="mb-8">
                    <h2 class="text-3xl font-bold font-serif" style="color: #004f39;">Restablecer Contraseña</h2>
                    <p class="text-sm text-gray-500 mt-2 font-serif">Ingresa tu nueva contraseña para continuar</p>
                </div>
                ...
                <form method="post" action="{{ route('password.update') }}">
                    ...
                    <div class="mb-5">
                        <label class="block text-sm font-semibold text-gray-700 mb-2 font-serif" for="password">Nueva Contraseña</label>
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="mb-6">
                        <label class="block text-sm font-semibold text-gray-700 mb-2 font-serif" for="password_confirmation">Confirmar Contraseña</label>
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
