...
@section('contenido')
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-3xl font-bold text-primary mb-1">Matrículas</h1>
            <p class="text-gray-600">Gestión de matrículas de estudiantes</p>
        </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 border-2 border-primary/20 hover:shadow-2xl transition-all">
                <div class="flex justify-between items-start">
                    <div class="flex items-start gap-4 flex-1">
                        ...
                        <div class="flex-1">
                            <h3 class="text-xl font-bold text-gray-800 mb-2">{{ $matricula->estudiante->nombreCompleto() }}</h3>
                            <div class="flex flex-wrap gap-2 mb-3">
                                ...
                                <span class="px-3 py-1 rounded-full text-xs font-bold border {{ $matricula->estado == 'activa' ? 'bg-green-100 text-green-700 border-green-300' : 'bg-red-100 text-red-700 border-red-300' }}">
