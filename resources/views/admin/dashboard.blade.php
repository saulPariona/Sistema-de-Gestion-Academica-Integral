...
@section('contenido')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        <div class="bg-white rounded-xl shadow-lg p-6 border-2 border-blue-200 hover:shadow-2xl transition-all">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 border-2 border-green-200 hover:shadow-2xl transition-all">
            <div class="flex items-center gap-4">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 border-2 border-purple-200 hover:shadow-2xl transition-all">
            <div class="flex items-center gap-4">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 border-2 border-orange-200 hover:shadow-2xl transition-all">
            <div class="flex items-center gap-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <a href="{{ route('admin.usuarios') }}"
            class="bg-white rounded-xl shadow-lg p-6 border-2 border-primary/20 hover:shadow-2xl hover:border-primary transition-all group">
