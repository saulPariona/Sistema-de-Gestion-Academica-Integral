...
@section('contenido')
    ...
    <form method="get" class="bg-white rounded-xl shadow-lg p-4 mb-6 border-2 border-primary/20">
        <div class="flex flex-wrap gap-3">
            <select name="periodo_id" class="flex-1 p-2 text-sm border-2 border-gray-300 rounded-lg focus:border-primary focus:outline-none">
                ...
                <div class="flex justify-between items-start">
                    <div class="flex-1">
                        ...
                        <div class="flex flex-wrap gap-2 mb-3">
                            ...
                            @empty
                                <span class="px-3 py-1 rounded-full text-xs font-bold bg-red-100 text-red-700 border border-red-300">Sin docente asignado</span>
                            @endforelse
                        </div>
                    </div>
                    <div class="flex gap-2 ml-4">
                        ...
                        <a href="{{ route('admin.cursos.asignar-docente', $curso->id) }}"
                            class="flex items-center gap-1 bg-green-600 text-white px-3 py-2 rounded-lg text-xs font-semibold hover:bg-green-700 transition-all shadow-md">
