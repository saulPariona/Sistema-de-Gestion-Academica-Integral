...
@section('contenido')
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-3xl font-bold text-primary mb-1">Editar Periodo Académico</h1>
            <p class="text-gray-600">{{ $periodo->nombre }}</p>
        </div>
    ...
    <div class="bg-white rounded-sm shadow-lg border-2 p-6 max-w-2xl mx-auto">
        <div class="flex items-center gap-3 mb-6 pb-4 border-b-2">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500">Modifica las fechas y estado</p>
            </div>
        </div>
